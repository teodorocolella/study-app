        ...
        {enabled.map((p) => {
          ...
          return (
            <button
              ...
              className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 py-2.5 text-sm font-medium text-slate-700 dark:text-slate-200 transition-colors hover:bg-slate-50"
            >
              <Icon />
              {meta.label}
            </button>
