    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f6f5fb] dark:bg-[#0f0e17] bg-[radial-gradient(circle_at_top,rgba(139,92,246,0.14),transparent_55%)] px-4">
      <div className="w-full max-w-sm animate-fade-in">
        <div className="mb-8 flex flex-col items-center">
          ...
          <h1 className="font-display text-2xl font-semibold text-slate-800 dark:text-slate-100">Welcome back</h1>
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Log in to keep up your streak.</p>
        </div>
